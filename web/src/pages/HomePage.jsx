      ...
      <div className="flex flex-1 flex-col p-8 lg:p-12 relative overflow-hidden">
        ...
        <nav className="flex items-center justify-between relative z-10">
          <div className="flex items-center gap-2.5">
            <div className="size-9 rounded-xl bg-linear-to-br from bg-amber-400 to-orange-500
          ...
          <div className="flex items-center gap-2">
            <SignInButton mode="modal">
              <button className="px-5 py-2.5 text-sm font-medium text-base-content transition">Sign In</button>
            </SignInButton>
        ...
        <div className="flex-1 flex flex-col justify-center max-w-xl relative z-10">
          ...
          <p className="mt-6 text-lg text-base-content/70 leading-relaxed max-w-md">
            A digital space where emotions, thoughts, and conversations come together.
          </p>
